...
from data_bank.orders_database import OrdersDatabaseHandler, OrdersDatabaseUpdater
...
def get_database_handler():
    ...
    if DB_HANDLER is None:
        DB_HANDLER = MineDatabaseHandler(EXECUTION_CONFIGS.db_user, EXECUTION_CONFIGS.db_password,
                                         EXECUTION_CONFIGS.db_database_name,
